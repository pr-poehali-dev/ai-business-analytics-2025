    ...
    solutions: [
      {
        ...
        result: "ИИ-решение анализирует бизнес-процессы в компании и на основании больших данных выявляет узкие места, которые можно улучшить. Не относится напрямую к оптимизации работы БА",
