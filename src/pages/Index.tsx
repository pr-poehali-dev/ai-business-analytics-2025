    ...
    solutions: [
      {
        ...
        description: "Инструмент для автоматизации и оптимизации процесса формулирования требований и описания задач в Jira. Помогает бизнес-аналитикам быстро создавать высококачественные и структурированные спецификации.",
        features: [
          { text: "Генерация User Story на основе целей, аудитории, контекста и критериев приемки" },
          { text: "Создание функционального описания задачи с целью, приоритетом и критериями успеха" },
          { text: "Формирование детализированных функциональных требований" },
          { text: "Проверка качества требований: выявление пробелов, неясностей и противоречий" },
          { text: "Работает непосредственно внутри Jira" },
          { text: "Экспорт требований в файлы разных форматов (PDF, Word)" }
        ],
        result: "Существенно облегчает рутинные задачи аналитики, повышает точность формулировки требований и ускоряет процессы проектирования и внедрения новых функций.",
