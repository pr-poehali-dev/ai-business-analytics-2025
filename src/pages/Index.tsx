          ...
          {companies.map((company, idx) => (
            ...
            >
              ...
              <CardContent className="p-5">
                {company.solutions.length > 3 ? (
                  <div className="flex gap-3 overflow-x-auto pb-3 scrollbar-thin scrollbar-thumb-neon-cyan scrollbar-track-muted">
                    {company.solutions.map((solution, sIdx) => (
                      <div
                        key={sIdx}
                        className="min-w-[280px] bg-muted/50 border border-border rounded-xl p-4 hover:bg-muted hover:border-neon-cyan hover:shadow-lg hover:shadow-neon-cyan/20 transition-all duration-300 hover:-translate-y-1"
                      >
                        <div className="flex items-start gap-2 mb-2">
                          <Icon name="Bot" size={20} className="text-neon-cyan mt-0.5 flex-shrink-0" />
                          <h4 className="font-bold text-neon-cyan text-base leading-tight">{solution.title}</h4>
                        </div>
                        ...
                        <a
                          ...
                          className="text-neon-cyan text-xs font-medium hover:text-neon-green transition-colors inline-flex items-center gap-1 hover:underline"
                        >
                          Источник
                  ...
                  <div className="space-y-4">
                    {company.solutions.map((solution, sIdx) => (
                      <div
                        key={sIdx}
                        className="bg-muted/50 border border-border rounded-xl p-4 hover:bg-muted hover:border-neon-cyan hover:shadow-lg hover:shadow-neon-cyan/20 transition-all duration-300"
                      >
                        <div className="flex items-start gap-2 mb-2">
                          <Icon name="Bot" size={20} className="text-neon-cyan mt-0.5 flex-shrink-0" />
                          <h4 className="font-bold text-neon-cyan text-base leading-tight">{solution.title}</h4>
